...
23	if (flag_digtype_dummy .eq. 1) then
		...
		!pule para o final da subroutine, já cavamos e vamos uniformizar a NOVA CI (CI uniformizada para novo corte)
		go to 26
